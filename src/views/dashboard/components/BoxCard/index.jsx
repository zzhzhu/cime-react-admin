      ...
      <div className="box-card-component">
        ...
        >
          <div style={{ position: 'relative' }}>
            <PanThumb image={'https://img1.baidu.com/it/u=1423066968,3514869688&fm=253&fmt=auto&app=120&f=JPEG?w=900&h=800'} className="panThumb" />
            <Mallki className="mallki-text" text="pear全球电商管理系统" />
